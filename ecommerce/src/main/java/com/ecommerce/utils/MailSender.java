...
public class MailSender {
	...
	public int sendRegistrationConfirmation(String toEmail) throws IOException {
		...
		// the sender email should be the same as we used to Create a Single Sender Verification
		    Email from = new Email("harika2407@gmail.com");
		    String subject = "Registration Successful! Happy Shopping";
		    Email to = new Email("bbhaskarn18@gmail.com");
		    ...
		    SendGrid sg = new SendGrid("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");
